...
public class RoomTypeStatisticData {
    ...
    public RoomTypeStatisticData() {
    }

    public RoomTypeStatisticData(String roomTypeName, int numberOccupiedRooms, float summaryGain) {
